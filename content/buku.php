                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a id="edit-buku" data-id="<?php echo $rowBuku['id'] ?>" href="?pg=tambah-buku&edit=<?php echo $rowBuku['id'] ?>" class="btn btn-success btn-sm">Edit</a>
                                        <a href="?pg=tambah-buku&delete=<?php echo $rowBuku['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">Delete</a>
                                    </td>
                                </tr>
                            <?php endwhile ?>
                        </tbody>
