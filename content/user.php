                    ...
                    <table class="table table-bordered table-striped table-hover mt-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a id="edit-user" data-id="<?php echo $rowUser['id'] ?>" href="?pg=tambah-user&edit=<?php echo $rowUser['id']?>" class="btn btn-success btn-sm">Edit</a>  
                                    <a href="?pg=tambah-user&delete=<?php echo $rowUser['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">Delete</a> 
                                </td>
                            </tr>
                            <?php endwhile ?>
                        </tbody>
